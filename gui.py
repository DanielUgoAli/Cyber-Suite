...
class CyberSuiteGUI(ctk.CTk):
    ...
    def create_vas_tab(self):
        ...
        self.vas_api_label = ctk.CTkLabel(api_frame, text="NVD API Key (optional, may increase search accuracy):")
        self.vas_api_label.pack(pady=5, side="left", padx=10)
        self.vas_api_entry = ctk.CTkEntry(api_frame, width=300, placeholder_text="Enter API key or leave empty")
        self.vas_api_entry.pack(pady=5, side="left", padx=10)
        
        # Help tooltip icon
        help_frame = ctk.CTkFrame(api_frame, fg_color="transparent")
        help_frame.pack(pady=5, side="left")
        ...
        def show_api_help():
            messagebox.showinfo(
                ...
                "You can get a free API key from the NVD website: https://nvd.nist.gov/developers/request-an-api-key"
            )
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by Cyber-Suite Toolkit | © 2025 ngCERT Interns</p>
        </div>
    </div>
</body>
</html>
